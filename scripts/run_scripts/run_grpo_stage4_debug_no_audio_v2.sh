...
echo "Candidates: num_generations=4"
echo "Reward functions: format + accuracy + people_focus + temporal_order"
echo "API evaluation mode: combined (single call evaluates two dimensions)"
echo "=========================================="
echo ""
