#!/bin/bash
# Ablation experiment: lambda_p=0.2, lambda_t=0.8

# Fixed parameters
LAMBDA_P=0.2        # people_focus weight
LAMBDA_T=0.8        # temporal_order weight
LAMBDA_ACC=0.4      # accuracy weight
LAMBDA_THINK=0.2    # thinking_focus weight

echo "=========================================="
echo "Ablation experiment: lp=0.2, lt=0.8"
echo "=========================================="
