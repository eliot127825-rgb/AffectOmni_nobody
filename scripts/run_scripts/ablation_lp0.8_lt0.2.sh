#!/bin/bash
# Ablation experiment: lambda_p=0.8, lambda_t=0.2

# Fixed parameters
LAMBDA_P=0.8        # people_focus weight
LAMBDA_T=0.2        # temporal_order weight
LAMBDA_ACC=0.4      # accuracy weight
LAMBDA_THINK=0.2    # thinking_focus weight

echo "=========================================="
echo "Ablation experiment: lp=0.8, lt=0.2"
echo "=========================================="
