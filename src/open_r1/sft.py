    ...
    if max_len > 32768:
        ...
        for idx, seq_len in enumerate(seq_lens):
            if seq_len > 32768:
                ...
                logger.error(f"[SEQUENCE TOO LONG] Prompt preview: {prompts[idx][:200]}...")
        raise AssertionError(f"Sequence too long: {max_len} > 32768. Check logs for offending samples.")
